...
export default function Navbar() {
	return (
		<header className="w-full max-w-[1200px] mx-auto px-4 h-[50px] flex items-center justify-between">
			...
			<div className="flex items-center space-x-4">
				<div className="flex items-center gap-2 text-foreground">
					...
					<span className="text-sm font-medium text-muted-foreground">105k</span>
				</div>
